...
export type AssetCondition = 'new' | 'second_hand' | 'reconditioned' | 'non_functioning'
...
export type CollateralSearchField = 'agreement_number' | 'debtor' | 'reg_serial_number' | 'financier'
