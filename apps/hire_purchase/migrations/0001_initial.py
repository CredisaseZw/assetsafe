    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agreement_number', models.CharField(db_index=True, help_text="The financier's own agreement reference number.", max_length=100, unique=True, verbose_name='Agreement Number')),
