    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identification_type', models.CharField(choices=[('national_id', 'National ID'), ('passport', 'Passport'), ('alien_id', 'Alien ID'), ('service_id', 'Service ID')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, null=True)),
                ('date_updated', models.DateTimeField(auto_now=True, null=True)),
                ('type', models.CharField(blank=True, choices=[('mobile', 'Mobile'), ('whatsapp', 'WhatsApp'), ('combined', 'Combined'), ('home', 'Home'), ('work', 'Work'), ('other', 'Other')], default='mobile', max_length=50)),
