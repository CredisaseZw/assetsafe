"""_summary_
Payement methods seeding script for the Assetsafe project.
...
class Command(BaseCommand):
    """Command to seed default payment methods for Assetsafe application."""

    help = "Seed default payment methods for Assetsafe application."
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(
            self.style.SUCCESS("Default payment methods seeded successfully.")
        )
